...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">298, sadhan socitey, bojalarm chowk, mota varachha, surat</span> <br>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 99784 97157</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">ruchitmordiya7373@gmail.com</span>
										<span class="text-white">parthkhunt02@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
							...
							<div class="col-md-12">
								<form class="w-100" action="#" method="post">
									<div class="row">
										...
										<button type="submit" value="send message" name="send" class="btn btn-info">Send Message</button>
									</div>
								</form>
							</div>
						</div>
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7438.560608367098!2d72.88733515371834!3d21.220730565199847!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04fb8fbb64eaf%3A0x97ef16c9b7671f7b!2sSilver%20Business%20Hub!5e0!3m2!1sen!2sin!4v1677669320160!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!--	Map -->
