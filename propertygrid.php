                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                if (isset($_REQUEST['filter'])) {
                                    ...
                                    $sql = "SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and type='{$type}' and stype='{$stype}' and price BETWEEN $min AND $max and city='{$city}'";
                        ...
                        <div class="col-lg-4">
                            <div class="sidebar-widget">
                                ...
                                <form class="d-inline-block w-100" action="calc.php" method="post">
                                    ...
                                    <button type="submit" value="submit" name="calc" class="btn btn-info mt-4">Calculate Instalment</button>
                                </form>
                            </div>
