...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage))
		{
			...
			$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage,status) VALUES ('$name','$email','$phone','$pass','$utype','$uimage','$status')";
									...
									<div class="form-group">
									 ...
									 <div class="form-check-inline">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="buyer" checked>Buyer
									  </label>
									</div>
									<div class="form-check-inline">
									  <label class="form-check-label">
