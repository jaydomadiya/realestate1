...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        ...
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-info font-13"></i>&nbsp; <?php echo $row['14'];?></span>
                                        <div class="price mt-3">
											<span class="text-info">₹&nbsp;<?php echo $row['13'];?></span>
										</div>
                                    </div>
								</td>
        ...
        <a class="btn btn-info d-none d-xl-block" href="submitproperty.php">Add Peoperty</a> 
	<!--	Submit property   -->
