                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <span class="mb-sm-20 d-block text-capitalize"><i class="fas fa-map-marker-alt text-info font-12"></i> &nbsp;<?php echo $row['14']; ?></span>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="property-details">
                                    ...
                                    <div class="agent-contact pt-60">
                                        <div class="row">
                                            <div class="col-sm-4 col-lg-3"> <img src="admin/user/<?php echo $row['uimage']; ?>" alt="user" height="200" width="170"> </div>
