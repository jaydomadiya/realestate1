                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <div class="user-info mt-md-50"> 
                                    <div class="user-image mb-4 mt-3">
                                    ...
                                    <div class="profile-button">
                                        <!-- <button class="update-btn" onclick="window.location.href='update_profile.php'" >Update Profile</button>
                                        <button class="change-btn">Change Password</button> -->
                                        <a class="btn btn-info d-none d-xl-block" href="update_profile.php">Update Profile</a>
                                        <a class="btn btn-info d-none d-xl-block" href="change_password.php">Change Password</a>
                                    </div>
									<?php } ?>
                                </div>
                            </div>
